...
sf::RenderWindow * Game::window = new sf::RenderWindow(sf::VideoMode(720, 576), "Snake", sf::Style::Titlebar | sf::Style::Close  );
...
std::string Game::texty;
sf::Text       Game::texts;

void Game::texty(std::string texts)
{
...
void Game::run()
{
    ...
    body.loadFromFile("body.jpg");
    //tile.loadFromFile("tile.jpg");
    food.loadFromFile("food.jpg");
